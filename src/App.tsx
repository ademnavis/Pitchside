...
function App() {
  ...
  return (
    <div className="h-screen w-screen bg-black p-3 sm:p-5 flex items-center justify-center overflow-hidden font-sans">
      <div className="flex flex-col h-full w-full max-w-lg bg-[#050505] text-[#e4e4e7] rounded-[40px] border border-white/[0.08] shadow-[0_0_50px_rgba(0,0,0,1)] overflow-hidden relative">
        ...
        <div className="bg-[#0f0f0f] border-b border-white/[0.05] px-5 py-5 shrink-0 relative overflow-hidden">
          ...
          <div className="flex justify-between items-start relative z-10 gap-4">
            ...
            <div className="flex-1 flex flex-col gap-1.5">
              ...
              <input 
                className="bg-white/5 border border-white/10 rounded-lg px-2.5 py-1.5 text-white text-[10px] font-black uppercase outline-none focus:border-blue-500/50 transition-all w-full"
                value={state.teamNames.A}
                onChange={(e) => setTeamName('A', e.target.value)}
                placeholder="Name"
              />
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-black text-blue-500">{state.score.A} <span className="text-[8px] text-zinc-600 ml-0.5">PTS</span></span>
            ...
            <div className="flex-1 flex flex-col gap-1.5 items-end">
              ...
              <input 
                className="bg-white/5 border border-white/10 rounded-lg px-2.5 py-1.5 text-white text-[10px] font-black uppercase outline-none focus:border-red-500/50 transition-all w-full text-right"
              ...
              <div className="flex items-center justify-between w-full">
                ...
                <span className="text-[10px] font-black text-red-500">{state.score.B} <span className="text-[8px] text-zinc-600 ml-0.5">PTS</span></span>
              </div>
            </div>
          </div>
          ...
          {activeTab === 'Pitch' ? (
            <>
              ...
              <div className="flex-1 bg-[#0a0a0a] border border-white/[0.05] rounded-[32px] p-2 relative flex items-center justify-center overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-4 right-4 flex flex-col gap-2 scale-75 origin-top-right z-30">
